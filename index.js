...
/////////////////
const BotName = 'Titann Botz☄'; 
const instagram = 'https://instagram.com/yatzz758.id'; 
const telegram = 'https://t.me/yatzz'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/YatzzEdtz_id';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@yatzz758.id')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@yatzz758.id`)
})
